...
>
> - Read the complete bash command from the structured permission payload's `full command` evidence so chained commands are reviewed as a whole.
...
- npm package: `@brglng/pi-auto-review`
